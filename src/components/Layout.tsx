      ...
      <div className="fixed w-full z-50 top-0">
        ...
        <header 
          className={`w-full transition-all duration-500 border-b border-transparent ${
            isScrolled || isDarkHeader ? 'bg-white/95 backdrop-blur-md shadow-sm border-gray-100 py-4' : 'bg-transparent py-6'
          }`}
        >
          <div className="max-w-[1800px] px-6 lg:px-12 flex justify-between items-center mx-auto">
            ...
            <div className="flex items-center gap-4 lg:gap-6">
              <a href="#contact" className={`hidden sm:block px-8 py-2.5 text-[11px] uppercase tracking-widest border rounded-full transition-all duration-300 ${
              ...
              <button 
                className={`p-3 border transition-all duration-300 z-[80] relative ${
                  mobileMenuOpen 
                ...
                <AnimatePresence mode="wait">
                  {!activeSubMenu ? (
                    ...
                    >
                      ...
                      <a href="/#estate" onClick={() => setMobileMenuOpen(false)} className="text-3xl font-serif text-[#2C3539] hover:text-[#A89F91] transition-colors">Resort</a>
                      <a href="/#amenities" onClick={() => setMobileMenuOpen(false)} className="text-3xl font-serif text-[#2C3539] hover:text-[#A89F91] transition-colors">Destination</a>
                      <a href="/#faq" onClick={() => setMobileMenuOpen(false)} className="text-3xl font-serif text-[#2C3539] hover:text-[#A89F91] transition-colors">Investment</a>
                      <a href="/#estate" onClick={() => setMobileMenuOpen(false)} className="text-3xl font-serif text-[#2C3539] hover:text-[#A89F91] transition-colors">Team</a>
                      ...
                      <a href="/#faq" onClick={() => setMobileMenuOpen(false)} className="text-3xl font-serif text-[#2C3539] hover:text-[#A89F91] transition-colors flex items-center group">
                        News <ChevronDown size={20} className="-rotate-90 ml-2 opacity-40 group-hover:opacity-100 transition-opacity" />
                      </a>
                    </motion.nav>
                  ) : (
                    <motion.div 
